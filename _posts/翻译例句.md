...
- Store pointers to any relevant views in an appropriate location, such as in the view controller that owns the views.<br />在适当位置保存相应视图的指针，例如在拥有视图的视图控制器中。
